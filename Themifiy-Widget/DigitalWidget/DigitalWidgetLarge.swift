...
struct DigitalMediumLarge: View {
...
struct DigitalMediumLarge_Previews: PreviewProvider {
    
    static let widget = WidgetModel(id: 101, name: "widget1",type: "digital",paid: false)
    static let date = Date()
    
    static var previews: some View {
        DigitalMediumLarge(widget: widget, date: date, isPreview: true, imgUrl: "").frame(width: 300, height: 300)
    }
}

...
struct DigitalWidgetSmall: View {
...
struct DigitalWidgetSmall_Previews: PreviewProvider {
    static let widget = WidgetModel(id: 101, name: "widget1",type: "digital",paid: false)
    static let date = Date()
    static var previews: some View {
        DigitalWidgetSmall(widget: widget, date: date, isPreview: true, imgUrl: "").frame(width: 150, height: 150)
    }
}
